    ...
    <form action="" id="policy-form">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="code" class="control-label">Policy Code</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="duration" class="control-label">Duration <small><em>(months)</em></small></label>
...
<!--                    <input type="file" accept = 'application/pdf' name="doc" id="doc" class="form-control form-control-sm form-control-border" >-->
<!--                    --><?php //if(isset($doc_path) && !empty($doc_path)): ?>
<!--                        <small><span class="text-muted">Current File: </span><a href="--><?php //= base_url.$doc_path ?><!--" target="_blank"><i class="fa fa-external-link-alt"></i> --><?php //= $id.'.png' ?><!--</a></small>-->
<!--                    --><?php //endif; ?>
<!--                </div>-->
                <div class="form-group">
