...
<div class="container-fluid">
    <form action="" id="insurance-form">
        ...
        <div class="form-group">
            <label for="registration_date" class="control-label">Date of Insurance Offer</label>
...
<!--            <input type="hidden" name="user_name" id="user_name" class="form-control form-control-sm form-control-border" placeholder="User Name" value ="--><?php //echo isset($user_name) ? $_settings->userdata('firstname').' '.$_settings->userdata('lastname') : '' ?><!--">-->
        </div>
...
<script>
    ...
    $(function(){
        ...
        $('#policy_id').change(function(){
            ...
            $('#policy_duration').text(parseFloat(duration).toLocaleString('en-US')+" month"+(duration > 1 ? "s" : ''))
            cal_xpyr()
        })
        ...
        //
        //// Set the value of the hidden username field
        //$('#user_name').val(newUsername);
        ...
        $('#uni_modal #insurance-form').submit(function(e){
            ...
            // Collect the username after the form submission is triggered
            var newUsername = '<?php echo $_settings->userdata('firstname').' '.$_settings->userdata('lastname'); ?>';
