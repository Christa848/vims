...
<body class="hold-transition ">
  ...
  <div class="h-100 d-flex align-items-center w-100" id="login">
    ...
    <div class="col-5 h-100 bg-gradient">
      <div class="d-flex w-100 h-300 justify-content-center align-items-center">
        <div class="card col-sm-12 col-md-6 col-lg-3 card-outline card-primary rounded-1 shadow">
