...
<div class="card card-outline card-primary rounded-0 shadow">
    <div class="card-header">
        <h3 class="card-title">Expired Insurances</h3>
        ...
        <div class="container-fluid">
            <div class="container-fluid">
                <table class="table table-bordered table-hover table-striped">
                    ...
                    if ($_settings->userdata('type') == 1):
                    $qry = $conn->query("SELECT * FROM `insurance_list` WHERE `expiration_date` < NOW()  ORDER BY DATE(`registration_date`) ASC ; ");
                    else:
                    $qry = $conn->query("SELECT * FROM `insurance_list` WHERE `expiration_date` < NOW() AND `user_name` = '" .$conn->real_escape_string($userName) . "' ORDER BY DATE(`registration_date`) ASC ; ");
                     endif;
