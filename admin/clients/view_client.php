...
<!--                                <div class="border col-auto flex-grow-1 flex-shrink-1" style="min-width:30%"><b>--><?php //= isset($dob) ? date("M d, Y", strtotime($dob)) : "" ?><!--</b></div>-->
                            </div>
                            <div class="row">
<!--                                <div class="border col-auto text-muted px-3" style="min-width:20%"><b>Email</b></div>-->
<!--                                <div class="border col-auto flex-grow-1 flex-shrink-1" style="min-width:30%"><b>--><?php //= isset($email) ? $email : "" ?><!--</b></div>-->
